            ...
            $.ajax({
                ...
                success:function(response){
                    ...
                    usuarios.forEach(usuario => {
                        plantilla +=` <tr Id_usuario=${usuario.id}>
                                ...
                                <td>
                                <button type="button" class="btn btn-success editbtn" style="color:white;" >
                                <i class="fa-solid fa-info"></i></button>
                                                         
                                <button type="submit" id="delet" data-id="${usuario.id}" class="btn btn-danger ml-1 delbtn" data-toggle="modal" data-target="#user_info">
                ...
                function eliminarUser(userId){
                    $("#user_info").submit(function(){
                        $.ajax({
                            url:"../model/eliminar_usuario.php",
                           type:"POST",
                           data:{userId: userId},
                            success:function(response){
                                if(!response.error){
